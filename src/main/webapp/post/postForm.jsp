...
<body>
<%-- 	<form id="frm2" action="${cp}/postPicture" method="get"> --%>
      ...
      <div class="row">
         ...
         <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <form id = "frm" class="form-horizontal" role="form"
            		action="${cp }/postForm" method="post"
      		...
      		<input type="hidden" id="parentPostNo" name="parentPostNo" value = "${parentPostNo }"/>
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <!-- id값 변경 x -->
                     <textarea name="postContent" id="smarteditor" rows="10" cols="100" style="width:766px; height:412px;">${param.postContent }</textarea> 
                  </div>
               </div>
                  ...
                  <div class="col-sm-10">
                     <input type="file" multiple="multiple" class="form-control" id="picture" name="picture"
								placeholder="첨부파일" value = "${param.fileName }">
               ...
               <div class="form-group">
                  <div class="col-sm-offset-2 col-sm-10">
                     <button type="button" id = "regBtn" class="btn btn-info">등록하기</button>
                  </div>
               </div>
            </form>
         </div>'
